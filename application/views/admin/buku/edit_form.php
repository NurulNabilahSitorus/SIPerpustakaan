            ...
            <div class="card-body">
              <form action="" method="post" enctype="multipart/form-data" >
                ...
                <div class="form-group">
                  ...
                  <input class="form-control <?php echo form_error('no_buku') ? 'is-invalid':'' ?>" type="number" name="no_buku" value="<?php echo $buku->no_buku?>"/>
                ...
                <div class="form-group">
                  ...
                  <input class="form-control <?php echo form_error('judul_buku') ? 'is-invalid':'' ?>" type="text" name="judul_buku" value="<?php echo $buku->judul_buku?>"/>
            		<div class="invalid-feedback">
                          ...
                          <input class="form-control <?php echo form_error('pengarang') ? 'is-invalid':'' ?>" type="text" name="pengarang" min="0" value="<?php echo $buku->pengarang?>"/>
                          <div class="invalid-feedback">
                 ...
                 <div class="form-group">
                          ...
                          type="text" name="penerbit" value="<?php echo $buku->penerbit?>"/>
                          <div class="invalid-feedback">
                ...
                <div class="form-group">
                          ...
                          type="date" name="tahun_terbit" value="<?php echo $buku->tahun_terbit?>"/>
                          <div class="invalid-feedback">
                ...
                <div class="form-group">
                          ...
                          type="text" name="jenis_buku" value="<?php echo $buku->jenis_buku?>" required/>
                ...
                <div class="form-group">
                          ...
                          type="number" name="jumlah_buku" value="<?php echo $buku->jumlah_buku?>"/>
                          <div class="invalid-feedback">
                    ...
                    <div class="form-group">
                          ...
                          type="text" name="status_buku" value="<?php echo $buku->status_buku?>"  required/>/>
