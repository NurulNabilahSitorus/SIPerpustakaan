    ...
    <!-- /.container-fluid -->
        <div class="card mb-3">
             <div class="card-header">
                  <a href="<?php echo site_url('admin/pinjam/') ?>"><i class="fas fa-arrow-left"></i> Back</a>
        </div>
            <div class="card-body">
            	<form action="" method="post" enctype="multipart/form-data" >
                <input type="hidden" name="id" value="<?php echo $pinjam->pinjam_id?>" />
            		<div class="form-group">
            			<label for="nomor_induk_siswa">Nomor Induk Siswa*</label>
            			<input class="form-control <?php echo form_error('nomor_induk_siswa') ? 'is-invalid':'' ?>" type="number" name="nomor_induk_siswa" value="<?php echo $pinjam->nomor_induk_siswa?>" />
                          ...
                          <input class="form-control <?php echo form_error('nama_siswa') ? 'is-invalid':'' ?>" type="text" name="nama_siswa" min="0" value="<?php echo $pinjam->nama_siswa?>"/>
                          <div class="invalid-feedback">
                 ...
                 <div class="form-group">
                          ...
                          type="text" name="kelas" value="<?php echo $pinjam->kelas?>"/>
                          <div class="invalid-feedback">
                ...
                <div class="form-group">
                          ...
                          type="number" name="no_buku" value="<?php echo $pinjam->no_buku?>"/>
                          <div class="invalid-feedback">
                ...
                <div class="form-group">
                          ...
                          type="text" name="judul_buku" value="<?php echo $pinjam->judul_buku?>"/>
                          <div class="invalid-feedback">
                ...
                <div class="form-group">
                          ...
                          type="text" name="penerbit" value="<?php echo $pinjam->penerbit?>"/>
                          <div class="invalid-feedback">
                    ...
                    <div class="form-group">
                          ...
                          type="date" name="tahun_terbit" value="<?php echo $pinjam->tahun_terbit?>"/>
                          <div class="invalid-feedback">
                ...
                <div class="form-group">
                          ...
                          type="date" name="tanggal_peminjaman" value="<?php echo $pinjam->tanggal_peminjaman?>"/>
                          <div class="invalid-feedback">
